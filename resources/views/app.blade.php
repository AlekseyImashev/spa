                    ...
                    <aside class="w-1/5">
                        <section class="mb-8">
                            ...
                            <ul class="list-reset">
                                ...
                                <li class="text-sm leading-loose"><router-link class="text-black" to="/logo-symbol">Logo Sumbol</router-link></li>
                        ...
                        <section>
                            ...
                            <ul class="list-reset">
                                ...
                                <li class="text-sm leading-loose"><router-link class="text-black" to="/loaders-and-animations">Loaders and Animatinons</router-link></li>
