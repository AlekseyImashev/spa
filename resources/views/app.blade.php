                    ...
                    <aside class="w-1/5">
                        <section class="mb-8">
                            ...
                            <ul class="list-reset">
                                ...
                                <li class="text-sm leading-loose"><router-link class="text-black" to="/about">Logo Sumbol</router-link></li>
                        ...
                        <section>
                            ...
                            <ul class="list-reset">
                                ...
                                <li class="text-sm leading-loose"><router-link class="text-black" to="/">Loaders and Animatinons</router-link></li>
